...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        Comparator<Point> slopeOrder = new SlopeOrder();
        return slopeOrder;
    }

    private class SlopeOrder implements Comparator<Point> {
        public int compare(Point v, Point w) {
            if (Double.compare(v.slopeTo(Point.this), w.slopeTo(Point.this)) < 0.0) {
                return -1;
            }
            else if (Double.compare(v.slopeTo(Point.this), w.slopeTo(Point.this)) > 0.0) {
                return +1;
            }
            else
                return +0;
